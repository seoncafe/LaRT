...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  call fits_put_keyword(unit,'ScatDust', par%save_dust_scattered,'Save Dust-Scattered Light', status)
  ...
  if (par%save_dust_scattered) then
     call fits_append_image(unit,obs%scatt_dust,status,bitpix=par%out_bitpix)
     call fits_put_keyword(unit,'EXTNAME','ScatDust','J(freq,x,y) (intensity)',status)
  endif
