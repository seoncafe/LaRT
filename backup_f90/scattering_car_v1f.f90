...
!DIR$ ATTRIBUTES INLINE :: voigt_mod_voigt
  ...
  if (par%DGR > 0.0_wp) then
     ...
     DnuHK  = grid%DnuHK_ref/grid%Dfreq(i1,i2,i3)
     pH     = voigt(photon%xfreq+DnuHK, grid%voigt_a(i1,i2,i3)) * one_over_three
     pK     = voigt(photon%xfreq,       grid%voigt_a(i1,i2,i3)) * two_over_three
...
!DIR$ ATTRIBUTES INLINE :: voigt_mod_voigt
    ...
    photon%nscatt_gas = photon%nscatt_gas + 1
#ifdef CALCP
    ...
    DnuHK = grid%DnuHK_ref/grid%Dfreq(photon%icell,photon%jcell,photon%kcell)
