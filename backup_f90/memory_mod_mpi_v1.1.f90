module memory_mod
  ...
  !integer(kind=MPI_ADDRESS_KIND), parameter :: int_size = int(sizeof(0),      MPI_ADDRESS_KIND)
  ...
  interface create_shared_mem
     module procedure create_shared_mem_1D, create_shared_mem_2D, create_shared_mem_3D, &
                      ...
                      create_shared_mem_1D_int, create_shared_mem_2D_int, create_shared_mem_3D_int
  ...
  interface create_mem
     module procedure create_mem_1D, create_mem_2D, create_mem_3D, create_mem_4D, create_mem_5D, &
                      create_mem_1D_int, create_mem_2D_int, create_mem_3D_int
  ...
  interface reduce_mem
     module procedure reduce_mem_1D, reduce_mem_2D, reduce_mem_3D, reduce_mem_4D, reduce_mem_5D, &
                      reduce_mem_1D_int, reduce_mem_2D_int, reduce_mem_3D_int
  end interface reduce_mem
  interface get_window
     module procedure get_window_1D, get_window_2D, get_window_3D, get_window_4D, get_window_5D, &
                      get_window_1D_int, get_window_2D_int, get_window_3D_int
  end interface get_window
  interface destroy_mem
     module procedure destroy_mem_1D, destroy_mem_2D, destroy_mem_3D, destroy_mem_4D, destroy_mem_5D, &
                      destroy_mem_1D_int, destroy_mem_2D_int, destroy_mem_3D_int
...
contains
  ...
  !---------------------------
  subroutine create_shared_mem_2D_int(array,arrshape)
  implicit none
  integer, pointer, intent(inout) :: array(:,:)
  ...
  if (.not.mpi_parameters_defined) call init_mpi_parameters()
  if (h_rank == 0) then
     wsize = int(arrshape(1)*arrshape(2), MPI_ADDRESS_KIND)*int_size
  else
     wsize = 0_MPI_ADDRESS_KIND
  endif
  ...
  end subroutine create_shared_mem_2D_int
  !---------------------------
  subroutine create_shared_mem_3D_int(array,arrshape)
  implicit none
  integer, pointer, intent(inout) :: array(:,:,:)
  ...
  if (.not.mpi_parameters_defined) call init_mpi_parameters()
  if (h_rank == 0) then
     wsize = int(arrshape(1)*arrshape(2)*arrshape(3), MPI_ADDRESS_KIND)*int_size
  else
     wsize = 0_MPI_ADDRESS_KIND
  endif
  ...
  end subroutine create_shared_mem_3D_int
  !---------------------------
  ...
  !---------------------------
  subroutine create_mem_2D_int(array,arrshape,shared_memory)
  implicit none
  integer, pointer,  intent(inout) :: array(:,:)
  integer,           intent(in)    :: arrshape(2)
  logical, optional, intent(in)    :: shared_memory
  ...
  if (present(shared_memory)) use_shared_memory = shared_memory
  if (use_shared_memory) then
     call create_shared_mem_2D_int(array,arrshape)
  else
     if (.not. associated(array)) allocate(array(arrshape(1),arrshape(2)))
     array = 0
  endif
  end subroutine create_mem_2D_int
  !---------------------------
  subroutine create_mem_3D_int(array,arrshape,shared_memory)
  implicit none
  integer, pointer,  intent(inout) :: array(:,:,:)
  integer,           intent(in)    :: arrshape(3)
  logical, optional, intent(in)    :: shared_memory
  ...
  if (present(shared_memory)) use_shared_memory = shared_memory
  if (use_shared_memory) then
     call create_shared_mem_3D_int(array,arrshape)
  else
     if (.not. associated(array)) allocate(array(arrshape(1),arrshape(2),arrshape(3)))
     array = 0
  endif
  end subroutine create_mem_3D_int
  !---------------------------
  ...
  !---------------------------
  subroutine reduce_mem_2D_int(array, shared_memory)
  implicit none
  integer, pointer,  intent(inout) :: array(:,:)
  logical, optional, intent(in)    :: shared_memory
  integer :: communicator, ierr, nsize
  ...
  end subroutine reduce_mem_2D_int
  !---------------------------
  subroutine reduce_mem_3D_int(array, shared_memory)
  implicit none
  integer, pointer,  intent(inout) :: array(:,:,:)
  logical, optional, intent(in)    :: shared_memory
  ...
  if (do_reduce) then
     ...
     do k=1, size(array(1,1,:))
        if (p_rank == 0) then
           call MPI_REDUCE(MPI_IN_PLACE,array(:,:,k),nsize,MPI_INTEGER,MPI_SUM,0,communicator,ierr)
        else
           call MPI_REDUCE(array(:,:,k),           0,nsize,MPI_INTEGER,MPI_SUM,0,communicator,ierr)
        endif
     enddo
  endif
  end subroutine reduce_mem_3D_int
  !---------------------------
  ...
  !---------------------------
  subroutine get_window_1D_int(arr, win)
  implicit none
  ...
  enddo
  end subroutine get_window_1D_int
  !---------------------------
  subroutine get_window_2D_int(arr, win)
  implicit none
  integer, pointer, intent(in)  :: arr(:,:)
  integer,          intent(out) :: win
  integer(MPI_ADDRESS_KIND) :: wsize
  ...
  enddo
  end subroutine get_window_2D_int
  !---------------------------
  subroutine get_window_3D_int(arr, win)
  implicit none
  integer, pointer, intent(in)  :: arr(:,:,:)
  integer,          intent(out) :: win
  integer(MPI_ADDRESS_KIND) :: wsize
  ...
  enddo
  end subroutine get_window_3D_int
  !---------------------------
  subroutine get_window_1D(arr, win)
  implicit none
  real(kind=wp), pointer, intent(in)  :: arr(:)
  integer,                intent(out) :: win
  integer(MPI_ADDRESS_KIND) :: wsize
  type(C_PTR) :: ptr_arr, ptr
  integer     :: disp_unit, ierr, i
  ...
  enddo
  end subroutine get_window_1D
  !---------------------------
  subroutine get_window_2D(arr, win)
  implicit none
  real(kind=wp), pointer, intent(in)  :: arr(:,:)
  integer,                intent(out) :: win
  integer(MPI_ADDRESS_KIND) :: wsize
  ...
  enddo
  end subroutine get_window_2D
  !---------------------------
  subroutine get_window_3D(arr, win)
  implicit none
  real(kind=wp), pointer, intent(in)  :: arr(:,:,:)
  integer,                intent(out) :: win
  integer(MPI_ADDRESS_KIND) :: wsize
  ...
  enddo
  end subroutine get_window_3D
  !---------------------------
  subroutine get_window_4D(arr, win)
  implicit none
  real(kind=wp), pointer, intent(in)  :: arr(:,:,:,:)
  integer,                intent(out) :: win
  integer(MPI_ADDRESS_KIND) :: wsize
  ...
  enddo
  end subroutine get_window_4D
  !---------------------------
  subroutine get_window_5D(arr, win)
  implicit none
  real(kind=wp), pointer, intent(in)  :: arr(:,:,:,:,:)
  integer,                intent(out) :: win
  integer(MPI_ADDRESS_KIND) :: wsize
  ...
  !---------------------------
  subroutine destroy_mem_1D_int(arr)
  implicit none
  integer, pointer, intent(inout) :: arr(:)
  integer :: win, ierr
  call get_window_1D_int(arr, win)
  ...
  end subroutine destroy_mem_1D_int
  !---------------------------
  subroutine destroy_mem_2D_int(arr)
  implicit none
  integer, pointer, intent(inout) :: arr(:,:)
  integer :: win, ierr
  call get_window_2D_int(arr, win)
  if (win /= MPI_WIN_NULL) then
     call destroy_shared_mem_window(win)
     nullify(arr)
  else
  ...
  end subroutine destroy_mem_2D_int
  !---------------------------
  subroutine destroy_mem_3D_int(arr)
  implicit none
  integer, pointer, intent(inout) :: arr(:,:,:)
  integer :: win, ierr
  call get_window_3D_int(arr, win)
  if (win /= MPI_WIN_NULL) then
     call destroy_shared_mem_window(win)
     nullify(arr)
  else
  ...
  end subroutine destroy_mem_3D_int
  !---------------------------
  subroutine destroy_mem_1D(arr)
  implicit none
  real(kind=wp), pointer, intent(inout) :: arr(:)
  integer :: win, ierr, i
  call get_window_1D(arr, win)
  if (win /= MPI_WIN_NULL) then
     call destroy_shared_mem_window(win)
     nullify(arr)
  else
  ...
  end subroutine destroy_mem_1D
  !---------------------------
  subroutine destroy_mem_2D(arr)
  implicit none
  real(kind=wp), pointer, intent(inout) :: arr(:,:)
  integer :: win
  call get_window_2D(arr, win)
  if (win /= MPI_WIN_NULL) then
     call destroy_shared_mem_window(win)
     nullify(arr)
  else
  ...
  end subroutine destroy_mem_2D
  !---------------------------
  subroutine destroy_mem_3D(arr)
  implicit none
  real(kind=wp), pointer, intent(inout) :: arr(:,:,:)
  integer :: win
  call get_window_3D(arr, win)
  if (win /= MPI_WIN_NULL) then
     call destroy_shared_mem_window(win)
     nullify(arr)
  else
  ...
  end subroutine destroy_mem_3D
  !---------------------------
  subroutine destroy_mem_4D(arr)
  implicit none
  real(kind=wp), pointer, intent(inout) :: arr(:,:,:,:)
  integer :: win
  call get_window_4D(arr, win)
  if (win /= MPI_WIN_NULL) then
     call destroy_shared_mem_window(win)
     nullify(arr)
  else
  ...
  end subroutine destroy_mem_4D
  !---------------------------
  subroutine destroy_mem_5D(arr)
  implicit none
  real(kind=wp), pointer, intent(inout) :: arr(:,:,:,:,:)
  integer :: win
  call get_window_5D(arr, win)
  if (win /= MPI_WIN_NULL) then
     call destroy_shared_mem_window(win)
     nullify(arr)
  else
