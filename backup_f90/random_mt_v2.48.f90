...
!==============================
  ...
  !------------------------------
  function rand_alias_constant64(prob_alias, alias, xaxis) result(xresult)
  ...
  !------------------------------
  function rand_alias_constant32(prob_alias, alias, xaxis) result(xresult)
  !--- requirement : size(prob_alias) = size(alias), size(xaxis) = size(probs_alias) + 1.
  implicit none
  ...
  !------------------------------
  function rand_alias_linear64(prob_alias, alias, xaxis, prob) result(xresult)
  ...
  !------------------------------
  function rand_alias_linear32(prob_alias, alias, xaxis, prob) result(xresult)
  !--- requirement : size(prob_alias) = size(alias), size(prob) = size(xaxis) = size(probs_alias) + 1.
  implicit none
  real(real32), intent(in) :: prob_alias(:)
  integer,      intent(in) :: alias(:)
