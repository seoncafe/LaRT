...
!++++++++++++++++++++++++++++++++++++++
  ...
  !   2 : doublet (two resonances)
  !   3 : two resonance lines with different f12 and damping constants.
  !   4 : one resonance + several (one or more) fluorescence (SiII 1527, FeII UV3 lines)
  ...
  case ('CIV_1548')
     ...
     line%g_recoil0 = (h_planck/massH/12.0_wp)/(line%wavelength0*um2m)**2
  case ('NV_1239')
     ...
     line%g_recoil0 = (h_planck/massH/14.0_wp)/(line%wavelength0*um2m)**2
  case ('OVI_1032')
     ...
     line%g_recoil0 = (h_planck/massH/16.0_wp)/(line%wavelength0*um2m)**2
  case ('NaI_D')
     ...
     line%cross0    = sigma_0/sqrt(pi)*line%f12(1)
     line%vtherm1   = 0.12843374_wp/sqrt(23.0_wp)
     line%DnuHK_Hz  = speedc_cm * (16973.36619_wp - 16956.17025_wp)
     line%g_recoil0 = (h_planck/massH/23.0_wp)/(line%wavelength0*um2m)**2
  case ('CaII_HK')
     ...
     line%cross0    = sigma_0/sqrt(pi)*line%f12(1)
     line%vtherm1   = 0.12843374_wp/sqrt(40.0_wp)
     line%DnuHK_Hz  = speedc_cm * (25414.40_wp - 25191.51_wp)
     line%g_recoil0 = (h_planck/massH/40.0_wp)/(line%wavelength0*um2m)**2
  case ('MgII_2796')
     ...
     line%g_recoil0 = (h_planck/massH/24.0_wp)/(line%wavelength0*um2m)**2
  case ('SiIV_1394')
     ...
     line%g_recoil0 = (h_planck/massH/28.0_wp)/(line%wavelength0*um2m)**2
  case ('AlII_1671')
     ...
     line%cross0    = sigma_0/sqrt(pi)*line%f12(1)
     line%vtherm1   = 0.12843374_wp/sqrt(27.0_wp)
     line%DnuHK_Hz  = 0.0_wp
     line%g_recoil0 = (h_planck/massH/27.0_wp)/(line%wavelength0*um2m)**2
     line%E1        = 1.0_wp
     line%E2        = 0.0_wp
     line%E3        = 1.0_wp
  case ('SiII_1527')
  ...
  case ('FeII_2250')
     ...
     line%cross0    = sigma_0/sqrt(pi)*line%f12(1)
     line%vtherm1   = 0.12843374_wp/sqrt(52.0_wp)
     line%g_recoil0 = (h_planck/massH/52.0_wp)/(line%wavelength0*um2m)**2
     line%nup       = 1
     allocate(line%b(line%nup))
  ...
  case default
     ...
     line%g_recoil0 = (h_planck/massH)/(line%wavelength0*um2m)**2
  endselect
