...
mpirun -machinefile $host_file $EXEC t2tau4.in
mpirun -machinefile $host_file $EXEC t2tau5.in
mpirun -machinefile $host_file $EXEC t2tau6.in
mpirun -machinefile $host_file $EXEC t2tau7.in

mpirun -machinefile $host_file $EXEC t3tau4.in
mpirun -machinefile $host_file $EXEC t3tau5.in
mpirun -machinefile $host_file $EXEC t3tau6.in
mpirun -machinefile $host_file $EXEC t3tau7.in
