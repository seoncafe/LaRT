...
ps_file = 'fig_uniform_sphere_voigt.pdf'
fname = "Nscatt_sphere_uniform_voigt.txt"
...
label  = r'uniform source, sphere, voigt'
...
label4 = r'$N_{\rm scatt} = %.4f\tau_0$ ($\tau_0\rightarrow 0$)' % s
