...
#echo "=== Clumpy sphere: tau0=1e3, N_cov=5, static ==="
#mpirun -machinefile ${host_file} ${EXEC} clump_tau3_ncov5.in
#
#echo "=== Clumpy sphere: tau0=1e4, N_cov=5, static ==="
#mpirun -machinefile ${host_file} ${EXEC} clump_tau4_ncov5.in
#
#echo "=== Clumpy sphere: tau0=1e3, N_cov=20, static (dense covering) ==="
#mpirun -machinefile ${host_file} ${EXEC} clump_tau3_ncov20.in
#
#echo "=== Clumpy sphere: tau0=1e3, N_cov=5, Hubble expansion Vexp=200 km/s ==="
#mpirun -machinefile ${host_file} ${EXEC} clump_tau3_ncov5_hubble.in
#
#echo "=== Clumpy sphere: tau0=1e3, N_cov=5, clump sigma_v=50 km/s ==="
#mpirun -machinefile ${host_file} ${EXEC} clump_tau3_ncov5_sigv.in

echo "=== Clumpy sphere: tau0=1e3, N_cov=5, peel-off observer ==="
mpirun -machinefile ${host_file} ${EXEC} clump_tau3_ncov5_peel.in
